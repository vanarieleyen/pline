            ...
            if (!plugin.settings.always_visible) {
                ...
                if (undefined !== icon) {
                    ...
                    if (plugin.settings.inside)
                        ...
                        icon.css({
                            'top': 5, 												// element_margin_top + ((element_height - icon_height) / 2),
                            'right': icon_width-icon_margin_right			//'left': element_margin_left + (element_width - icon_width - icon_margin_right)
                        });
